...
function dv_baseHandler(){function G(c){try{var b=new URL(c);return!b.pathname||""==b.pathname||"/"==b.pathname}catch(e){}}function L(c){var b=window._dv_win,e=0;try{for(;10>e;){if(b[c]&&"object"===typeof b[c])return!0;if(b==b.parent)break;e++;b=b.parent}}catch(f){}return!1}function M(){var c="http:";"http:"!=window._dv_win.location.protocol&&(c="https:");return c}function H(c,b){var e=document.createElement("iframe");e.name=window._dv_win.dv_config.emptyIframeID||"iframe_"+A();e.width=0;e.height=
0;e.id=b;e.style.display="none";e.src=c;return e}function B(c,b,e){e=e||150;var f=window._dv_win||window;if(f.document&&f.document.body)return b&&b.parentNode?b.parentNode.insertBefore(c,b):f.document.body.insertBefore(c,f.document.body.firstChild),!0;if(0<e)setTimeout(function(){B(c,b,--e)},20);else return!1}function N(c){var b=window._dv_win.dv_config=window._dv_win.dv_config||{};b.cdnAddress=b.cdnAddress||"cdn.doubleverify.com";return'<html><head><script type="text/javascript">('+function(){try{window.$dv=
window.$dvbs||parent.$dvbs,window.$dv.dvObjType="dvbs"}catch(e){}}.toString()+')();\x3c/script></head><body><script type="text/javascript">('+(c||"function() {}")+')("'+b.cdnAddress+'");\x3c/script><script type="text/javascript">setTimeout(function() {document.close();}, 0);\x3c/script></body></html>'}function O(c){var b=null;try{if(b=c&&c.contentDocument)return b}catch(e){}try{if(b=c.contentWindow&&c.contentWindow.document)return b}catch(e){}try{if(b=window._dv_win.frames&&window._dv_win.frames[c.name]&&
window._dv_win.frames[c.name].document)return b}catch(e){}return null}function I(c){var b=0,e;for(e in c)c.hasOwnProperty(e)&&++b;return b}function P(c,b){a:{var e={};try{if(c&&c.performance&&c.performance.getEntries){var f=c.performance.getEntries();for(c=0;c<f.length;c++){var d=f[c],g=d.name.match(/.*\/(.+?)\./);if(g&&g[1]){var l=g[1].replace(/\d+$/,""),k=b[l];if(k){for(var q=0;q<k.stats.length;q++){var t=k.stats[q];e[k.prefix+t.prefix]=Math.round(d[t.name])}delete b[l];if(!I(b))break}}}}var h=
e;break a}catch(w){}h=void 0}if(h&&I(h))return h}function Q(c,b){var e,f=window._dv_win.document.visibilityState;window[c.tagObjectCallbackName]=function(d){var g=window._dv_win.$dvbs;if(g){var l=b?"https:":M();e=d.ImpressionID;g.tags.add(d.ImpressionID,c);g.tags[d.ImpressionID].set({tagElement:c.script,impressionId:d.ImpressionID,dv_protocol:c.protocol,protocol:l,uid:c.uid,serverPublicDns:d.ServerPublicDns,ServerPublicDns:d.ServerPublicDns});c.script&&c.script.dvFrmWin&&(c.script.dvFrmWin.$uid=d.ImpressionID,
g.messages&&g.messages.startSendingEvents&&g.messages.startSendingEvents(c.script.dvFrmWin,d.ImpressionID));(function(){function b(){var e=window._dv_win.document.visibilityState;"prerender"===f&&"prerender"!==e&&"unloaded"!==e&&(f=e,window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(c,b))}if("prerender"===f)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbs.registerEventCall(d.ImpressionID,
{prndr:0});else{var c;"undefined"!==typeof window._dv_win.document.hidden?c="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?c="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?c="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(c="webkitvisibilitychange");window._dv_win.document.addEventListener(c,b,!1)}})()}if("1"!=c.foie)try{var k=P(window,{verify:{prefix:"vf",stats:[{name:"duration",prefix:"dur"}]}});k&&window._dv_win.$dvbs.registerEventCall(d.ImpressionID,
k)}catch(q){}};window[c.callbackName]=function(b){var d=window._dv_win.$dvbs&&"object"==typeof window._dv_win.$dvbs.tags[e]?window._dv_win.$dvbs.tags[e]:c;var f=window._dv_win.dv_config.bs_renderingMethod||function(b){document.write(b)};switch(b.ResultID){case 1:d.tagPassback?f(d.tagPassback):b.Passback?f(decodeURIComponent(b.Passback)):b.AdWidth&&b.AdHeight&&f(decodeURIComponent("%3Cstyle%3E%0A.dvbs_container%20%7B%0A%09border%3A%201px%20solid%20%233b599e%3B%0A%09overflow%3A%20hidden%3B%0A%09filter%3A%20progid%3ADXImageTransform.Microsoft.gradient(startColorstr%3D%27%23315d8c%27%2C%20endColorstr%3D%27%2384aace%27)%3B%0A%09%2F*%20for%20IE%20*%2F%0A%09background%3A%20-webkit-gradient(linear%2C%20left%20top%2C%20left%20bottom%2C%20from(%23315d8c)%2C%20to(%2384aace))%3B%0A%09%2F*%20for%20webkit%20browsers%20*%2F%0A%09background%3A%20-moz-linear-gradient(top%2C%20%23315d8c%2C%20%2384aace)%3B%0A%09%2F*%20for%20firefox%203.6%2B%20*%2F%0A%7D%0A.dvbs_cloud%20%7B%0A%09color%3A%20%23fff%3B%0A%09position%3A%20relative%3B%0A%09font%3A%20100%25%22Times%20New%20Roman%22%2C%20Times%2C%20serif%3B%0A%09text-shadow%3A%200px%200px%2010px%20%23fff%3B%0A%09line-height%3A%200%3B%0A%7D%0A%3C%2Fstyle%3E%0A%3Cscript%20type%3D%22text%2Fjavascript%22%3E%0A%09function%0A%20%20%20%20cloud()%7B%0A%09%09var%20b1%20%3D%20%22%3Cdiv%20class%3D%5C%22dvbs_cloud%5C%22%20style%3D%5C%22font-size%3A%22%3B%0A%09%09var%20b2%3D%22px%3B%20position%3A%20absolute%3B%20top%3A%20%22%3B%0A%09%09document.write(b1%20%2B%20%22300px%3B%20width%3A%20300px%3B%20height%3A%20300%22%20%2B%20b2%20%2B%20%2234px%3B%20left%3A%2028px%3B%5C%22%3E.%3C%5C%2Fdiv%3E%22)%3B%0A%09%09document.write(b1%20%2B%20%22300px%3B%20width%3A%20300px%3B%20height%3A%20300%22%20%2B%20b2%20%2B%20%2246px%3B%20left%3A%2010px%3B%5C%22%3E.%3C%5C%2Fdiv%3E%22)%3B%0A%09%09document.write(b1%20%2B%20%22300px%3B%20width%3A%20300px%3B%20height%3A%20300%22%20%2B%20b2%20%2B%20%2246px%3B%20left%3A50px%3B%5C%22%3E.%3C%5C%2Fdiv%3E%22)%3B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%0A%09%09document.write(b1%20%2B%20%22400px%3B%20width%3A%20400px%3B%20height%3A%20400%22%20%2B%20b2%20%2B%20%2224px%3B%20left%3A20px%3B%5C%22%3E.%3C%5C%2Fdiv%3E%22)%3B%0A%20%20%20%20%7D%0A%20%20%20%20%0A%09function%20clouds()%7B%0A%20%20%20%20%20%20%20%20var%20top%20%3D%20%5B%27-80%27%2C%2780%27%2C%27240%27%2C%27400%27%5D%3B%0A%09%09var%20left%20%3D%20-10%3B%0A%20%20%20%20%20%20%20%20var%20a1%20%3D%20%22%3Cdiv%20style%3D%5C%22position%3A%20relative%3B%20top%3A%20%22%3B%0A%09%09var%20a2%20%3D%20%22px%3B%20left%3A%20%22%3B%0A%20%20%20%20%20%20%20%20var%20a3%3D%20%22px%3B%5C%22%3E%3Cscr%22%2B%22ipt%20type%3D%5C%22text%5C%2Fjavascr%22%2B%22ipt%5C%22%3Ecloud()%3B%3C%5C%2Fscr%22%2B%22ipt%3E%3C%5C%2Fdiv%3E%22%3B%0A%20%20%20%20%20%20%20%20for(i%3D0%3B%20i%20%3C%208%3B%20i%2B%2B)%20%7B%0A%09%09%09document.write(a1%2Btop%5B0%5D%2Ba2%2Bleft%2Ba3)%3B%0A%09%09%09document.write(a1%2Btop%5B1%5D%2Ba2%2Bleft%2Ba3)%3B%0A%09%09%09document.write(a1%2Btop%5B2%5D%2Ba2%2Bleft%2Ba3)%3B%0A%09%09%09document.write(a1%2Btop%5B3%5D%2Ba2%2Bleft%2Ba3)%3B%0A%09%09%09if(i%3D%3D4)%0A%09%09%09%7B%0A%09%09%09%09left%20%3D-%2090%3B%0A%09%09%09%09top%20%3D%20%5B%270%27%2C%27160%27%2C%27320%27%2C%27480%27%5D%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%20%20%20%20%20%20else%20%0A%09%09%09%09left%20%2B%3D%20160%3B%0A%09%09%7D%0A%09%7D%0A%0A%3C%2Fscript%3E%0A%3Cdiv%20class%3D%22dvbs_container%22%20style%3D%22width%3A%20"+
b.AdWidth+"px%3B%20height%3A%20"+b.AdHeight+"px%3B%22%3E%0A%09%3Cscript%20type%3D%22text%2Fjavascript%22%3Eclouds()%3B%3C%2Fscript%3E%0A%3C%2Fdiv%3E"));break;case 2:case 3:d.tagAdtag&&f(d.tagAdtag);break;case 4:b.AdWidth&&b.AdHeight&&f(decodeURIComponent("%3Cstyle%3E%0A.dvbs_container%20%7B%0A%09border%3A%201px%20solid%20%233b599e%3B%0A%09overflow%3A%20hidden%3B%0A%09filter%3A%20progid%3ADXImageTransform.Microsoft.gradient(startColorstr%3D%27%23315d8c%27%2C%20endColorstr%3D%27%2384aace%27)%3B%0A%7D%0A%3C%2Fstyle%3E%0A%3Cdiv%20class%3D%22dvbs_container%22%20style%3D%22width%3A%20"+
b.AdWidth+"px%3B%20height%3A%20"+b.AdHeight+"px%3B%22%3E%09%0A%3C%2Fdiv%3E"))}}}function R(c){var b=null,e=null,f=function(b){var c=dv_GetParam(b,"cmp");b=dv_GetParam(b,"ctx");return"919838"==b&&"7951767"==c||"919839"==b&&"7939985"==c||"971108"==b&&"7900229"==c||"971108"==b&&"7951940"==c?"</scr'+'ipt>":/<\/scr\+ipt>/g}(c.src);"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var d=function(c){!(c=c.previousSibling)||"#text"!=c.nodeName||
null!=c.nodeValue&&void 0!=c.nodeValue&&0!=c.nodeValue.trim().length||(c=c.previousSibling);if(c&&"SCRIPT"==c.tagName&&c.getAttribute("type")&&("text/adtag"==c.getAttribute("type").toLowerCase()||"text/passback"==c.getAttribute("type").toLowerCase())&&""!=c.innerHTML.trim()){if("text/adtag"==c.getAttribute("type").toLowerCase())return b=c.innerHTML.replace(f,"\x3c/script>"),{isBadImp:!1,hasPassback:!1,tagAdTag:b,tagPassback:e};if(null!=e)return{isBadImp:!0,hasPassback:!1,tagAdTag:b,tagPassback:e};
e=c.innerHTML.replace(f,"\x3c/script>");c=d(c);c.hasPassback=!0;return c}return{isBadImp:!0,hasPassback:!1,tagAdTag:b,tagPassback:e}};return d(c)}function J(c,b,e,f,d,g,l,k,q,t,h,w){void 0==b.dvregion&&(b.dvregion=0);try{f.depth=S(f);var n=T(f);var m="&aUrl="+encodeURIComponent(n.url);var p="&aUrlD="+n.depth;var v=f.depth+d;g&&f.depth--}catch(u){p=m=v=f.depth=""}void 0!=b.aUrl&&(m="&aUrl="+b.aUrl);a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var r=1;break a}}catch(u){}r=
0}g=function(){function c(b){d++;var e=b.parent==b;return b.mraid||e?b.mraid:20>=d&&c(b.parent)}var b=window._dv_win||window,d=0;try{return c(b)}catch(x){}}();d=b.script.src;r="&ctx="+(dv_GetParam(d,"ctx")||"")+"&cmp="+(dv_GetParam(d,"cmp")||"")+"&plc="+(dv_GetParam(d,"plc")||"")+"&sid="+(dv_GetParam(d,"sid")||"")+"&advid="+(dv_GetParam(d,"advid")||"")+"&adsrv="+(dv_GetParam(d,"adsrv")||"")+"&unit="+(dv_GetParam(d,"unit")||"")+"&isdvvid="+(dv_GetParam(d,"isdvvid")||"")+"&uid="+b.uid+"&tagtype="+(dv_GetParam(d,
...
0,{}));b.hasOwnProperty("err")&&(c=b.err);return{vdcv:26,vdcd:b.res,err:c}}catch(e){return{vdcv:26,vdcd:"0",err:c}}}function S(c){for(var b=0;10>b&&c!=window._dv_win.top;)b++,c=c.parent;return b}function T(c){try{if(1>=c.depth)return{url:"",depth:""};var b=[];b.push({win:window._dv_win.top,depth:0});for(var e,f=1,d=0;0<f&&100>d;){try{if(d++,e=b.shift(),f--,0<e.win.location.toString().length&&e.win!=c)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,
depth:e.depth-1}}catch(k){}var g=e.win.frames.length;for(var l=0;l<g;l++)b.push({win:e.win.frames[l],depth:e.depth+1}),f++}return{url:"",depth:""}}catch(k){return{url:"",depth:""}}}function X(){var c=window._dv_win[F("=@42E:@?")][F("2?46DE@C~C:8:?D")];if(c&&0<c.length){var b=[];b[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var e=0;e<c.length;e++)b[e+1]=c[e];return b.reverse().join(",")}return null}function F(c){new String;var b=new String,e;for(e=0;e<c.length;e++){var f=
c.charAt(e);var d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(f);0<=d&&(f="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94));b+=f}return b}function A(){return Math.floor(1E12*(Math.random()+""))}function U(c){for(var b=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/",verRegex:"(MSIE |rv:| Edge/)"},{id:2,
brRegex:"Firefox",verRegex:"Firefox/"},{id:0,brRegex:"Mozilla.*Android.*AppleWebKit(?!.*Chrome.*)|Linux.*Android.*AppleWebKit.* Version/.*Chrome",verRegex:null},{id:0,brRegex:"AOL/.*AOLBuild/|AOLBuild/.*AOL/|Puffin|Maxthon|Valve|Silk|PLAYSTATION|PlayStation|Nintendo|wOSBrowser",verRegex:null},{id:3,brRegex:"Chrome",verRegex:"Chrome/"},{id:5,brRegex:"Safari|(OS |OS X )[0-9].*AppleWebKit",verRegex:"Version/"}],e=0,f="",d=0;d<b.length;d++)if(null!=c.match(new RegExp(b[d].brRegex))){e=b[d].id;if(null==
b[d].verRegex)break;c=c.match(new RegExp(b[d].verRegex+"[0-9]*"));null!=c&&(f=c[0].match(new RegExp(b[d].verRegex)),f=c[0].replace(f[0],""));break}b=ca();return{ID:b,version:b===e?f:"",ID_UA:e}}function ca(){try{if(null!=window._phantom||null!=window.callPhantom)return 99;if(document.documentElement.hasAttribute&&document.documentElement.hasAttribute("webdriver")||null!=window.domAutomation||null!=window.domAutomationController||null!=window._WEBDRIVER_ELEM_CACHE)return 98;if(void 0!=window.opera&&
...
void 0!=window.InstallTrigger.install)return 2;if(void 0!=document.uniqueID&&"string"==typeof document.uniqueID&&(void 0!=document.documentMode&&0<=document.documentMode||void 0!=document.all&&"object"==typeof document.all||void 0!=window.ActiveXObject&&"function"==typeof window.ActiveXObject)||window.document&&window.document.updateSettings&&"function"==typeof window.document.updateSettings)return 1;var c=!1;try{var b=document.createElement("p");b.innerText=".";b.style="text-shadow: rgb(99, 116, 171) 20px -12px 2px";
c=void 0!=b.style.textShadow}catch(e){}return(0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")||window.webkitAudioPannerNode&&window.webkitConvertPointFromNodeToPage)&&c&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(e){return 0}}function Y(){try{var c=0,b=function(b,d){d&&32>b&&(c=(c|1<<b)>>>0)},e=function(b,c){return function(){return b.apply(c,arguments)}},f="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?
...
(h=cssToDOM(h));if(void 0!==k.style[h])return e(),"pfx"==c?h:!0}e();return!1},t=function(b,c,d){var f=b.charAt(0).toUpperCase()+b.slice(1),k=(b+" "+g.join(f+" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)return q(k,c);k=(b+" "+l.join(f+" ")+f).split(" ");for(var h in k)if(k[h]in c){if(!1===d)return k[h];b=c[k[h]];return"function"===typeof b?e(b,d||c):b}return!1};b(0,!0);b(1,t("requestFileSystem",window));b(2,window.CSS?"function"==typeof window.CSS.escape:!1);b(3,t("shapeOutside",
"content-box",!0));return c}catch(h){return 0}}function K(){var c=window,b=0;try{for(;c.parent&&c!=c.parent&&c.parent.document&&!(c=c.parent,10<b++););}catch(e){}return c}function Z(){try{var c=K(),b=0,e=0,f=function(c,d,f){f&&(b=(b|1<<c)>>>0,e=(e|1<<d)>>>0)},d=c.document;f(14,0,c.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));f(14,1,(c.CustomWLAdServer||c.DbcbdConfig)&&(a=d.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));f(15,2,c.zpz&&c.zpz.createPlayer);
f(15,3,c.vdApp&&c.vdApp.createPlayer);f(15,4,d.querySelector('body>div[class="z-z-z"]'));f(16,5,c.xy_checksum&&c.place_player&&(c.logjwonready&&c.logContentPauseRequested||c.jwplayer));f(17,6,c==c.top&&""==d.title?(a=d.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);f(17,7,d.querySelector('script[src*="sitewebvideo.com"]'));f(17,8,c.InitPage&&c.cef&&c.InitAd);f(17,9,c==c.top&&""==d.title?(a=d.querySelector("body>#player"),
null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);f(17,10,c==c.top&&""==d.title&&c.InitAdPlayer?(a=d.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);f(17,11,null!=c.clickplayer&&null!=c.checkRdy2);f(19,12,c.instance&&c.inject&&d.querySelector('path[id="cp-search-0"]'));return{f:b,s:e}}catch(g){return null}}function aa(){try{var c="&fcifrms="+window.top.length;window.history&&(c+=
"&brh="+window.history.length);var b=K(),e=b.document;if(b==window.top){c+="&fwc="+((b.FB?1:0)+(b.twttr?2:0)+(b.outbrain?4:0)+(b._taboola?8:0));try{e.cookie&&(c+="&fcl="+e.cookie.length)}catch(f){}b.performance&&b.performance.timing&&0<b.performance.timing.domainLookupStart&&0<b.performance.timing.domainLookupEnd&&(c+="&flt="+(b.performance.timing.domainLookupEnd-b.performance.timing.domainLookupStart));e.querySelectorAll&&(c+="&fec="+e.querySelectorAll("*").length)}return c}catch(f){return""}}function W(){function c(b){if(null==
...
D=E}b=b+D&4294967295;n=n+y&4294967295;m=m+x&4294967295;p=p+z&4294967295;v=v+A&4294967295}return d(b)+d(n)+d(m)+d(p)+d(v)}function b(){try{return!!window.sessionStorage}catch(g){return!0}}function e(){try{return!!window.localStorage}catch(g){return!0}}function f(){try{var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",
2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}}catch(k){}return null}try{var d=[];d.push(["lang",navigator.language||navigator.browserLanguage]);d.push(["tz",(new Date).getTimezoneOffset()]);d.push(["hss",b()?"1":"0"]);d.push(["hls",e()?"1":"0"]);d.push(["odb",typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",f()]);return c(d.join("=!!!="))}catch(g){return null}}
this.createRequest=function(){var c=!1,b=window._dv_win,e=0,f=!1,d;try{for(d=0;10>=d;d++)if(null!=b.parent&&b.parent!=b)if(0<b.parent.location.toString().length)b=b.parent,e++,c=!0;else{c=!1;break}else{0==d&&(c=!0);break}}catch(v){c=!1}a:{try{var g=b.$sf;break a}catch(v){}g=void 0}if(0==b.document.referrer.length)c=b.location;else if(c)c=b.location;else{c=b.document.referrer;if(G(c)){a:{try{var l=b.$sf&&b.$sf.ext&&b.$sf.ext.hostURL&&b.$sf.ext.hostURL();break a}catch(v){}l=void 0}if(l&&!G(l)&&0==l.indexOf(c)){c=
...
q._fallback_.RecoveryTagID:1,1===q&&n.tagAdtag?document.write(n.tagAdtag):2===q&&n.tagPassback&&document.write(n.tagPassback)),n=!0):n=!1;if(n)return{isSev1:!0};this.dvStep=2;Q(p,m);l=l&&l.parentElement&&l.parentElement.tagName&&"HEAD"===l.parentElement.tagName;this.dvStep=3;return J(this,p,c,b,e,f,d,h,l,m,k,g)};this.sendRequest=function(c){var b=dv_GetParam(c,"tagformat");b&&"2"==b?$dvbs.domUtilities.addScriptResource(c,document.body):dv_sendScriptRequest(c);try{if("1"!=dv_GetParam(c,"foie")){var e=
N(this.dv_script_obj&&this.dv_script_obj.injScripts),f=H("about:blank");f.id=f.name;var d=f.id.replace("iframe_","");f.setAttribute&&f.setAttribute("data-dv-frm",d);B(f,this.dv_script);if(this.dv_script){var g=this.dv_script;a:{c=null;try{if(c=f.contentWindow){var l=c;break a}}catch(t){}try{if(c=window._dv_win.frames&&window._dv_win.frames[f.name]){l=c;break a}}catch(t){}l=null}g.dvFrmWin=l}var k=O(f);if(k)k.open(),k.write(e);else{try{document.domain=document.domain}catch(t){}var q=encodeURIComponent(e.replace(/'/g,
...
function(){return"ver"};this.getVersion=function(){return"109"}};
